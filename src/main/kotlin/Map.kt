fun main() {
    ...
    // wo maps  containing teh equal pairs are equal regardless of the pair order.
    val anotherMap = mapOf("key2" to 2, "key1" to 1, "key4" to 1, "key3" to 3)
    println("The maps are equal: ${numbersMap == anotherMap}")

    //mutablemap is a map with map write operations,for example,
    //you can add anew key-value pair or update the value associated with the given key
